...
import { determineUserHandle, logger, handleConditionalCheckFailedException, UserFacingError, withCommonHeaders, isValidOrigin, } from "./common.js";
...
async function handleCredentialsResponse(userId, body) {
    ...
    if (!isValidOrigin(clientData.origin, allowedOrigins, allowedApplicationOrigins)) {
